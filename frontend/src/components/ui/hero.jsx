  ...
  return (
    <div className="text-left text-white pt-16 sm:pt-24 md:pt-32 px-4 max-w-3xl">
      <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 leading-tight tracking-wide">
        ...
        events into <br className="sm:hidden" />
        unforgettable experiences.
      </h1>
      <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 opacity-80 max-w-xl">
        Complete event management solution with seamless ticket booking, QR code
        generation, and secure Razorpay payment integration. Create, manage, and
        scale your events effortlessly.
      </p>
      ...
      <div className="container mx-auto px-4 py-4 md:px-6 lg:px-8 flex items-center justify-between">
        <div className="flex items-center space-x-6 lg:space-x-8">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <div
              className="relative group"
              onMouseEnter={() => handleMouseEnterNavItem("solutions")}
              onMouseLeave={handleMouseLeaveNavItem}
            >
              <a
                href="#"
                className={navLinkClass("solutions", "flex items-center")}
              >
                Solutions
                <svg
                  className="ml-1 w-3 h-3 group-hover:rotate-180 transition-transform duration-200"
