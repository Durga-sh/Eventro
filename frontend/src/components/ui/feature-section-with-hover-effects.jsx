...
export function FeaturesSectionWithHoverEffects() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Automated ticket delivery via email with QR codes and event details immediately after purchase.",
      icon: <IconBolt />,
    },
    {
      title: "Multi-Event Support",
      description:
        "Manage multiple events simultaneously with our powerful dashboard and organizational tools.",
      icon: <IconTicket />,
    },
  ];
