  ...
  const testimonials = [
    {
      ...
      content:
        "Eventro has transformed how we manage our tech conferences. The QR code system and payment integration are seamless.",
      rating: 5,
      avatar: "SJ",
    },
    {
      ...
      content:
        "The analytics dashboard gives us incredible insights. We've increased our event attendance by 40% since switching to Eventro.",
      rating: 5,
      avatar: "MC",
    },
    {
      ...
      content:
        "Simple, powerful, and reliable. Eventro handles everything from small meetups to large conferences effortlessly.",
      rating: 5,
      avatar: "ER",
    },
  ];
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            ...
            have transformed their events with Eventro
          </p>
        </div>
